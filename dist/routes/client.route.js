 ...
 */
routerClient.get("/:id", [(0, authenticateToken_1.authentification)(), (0, authenticateToken_1.roleautorisation)(["BOUTIQUIER"])], clientController.GetById);
/**
 * @openapi
 * /api/v1/clients/{id}:
 *   put:
 ...
 *         description: Erreur serveur
 */
routerClient.put("/:id", [(0, authenticateToken_1.authentification)(), (0, authenticateToken_1.roleautorisation)(["BOUTIQUIER"])], clientController.updateClient);
/**
 * @openapi
 ...
 *         description: Erreur serveur
 */
routerClient.post("/telephone", [(0, authenticateToken_1.authentification)(), (0, authenticateToken_1.roleautorisation)(["BOUTIQUIER"])], clientController.GetByTelephone);
/**
 * @openapi
 * /api/v1/clients:
 *   get:
